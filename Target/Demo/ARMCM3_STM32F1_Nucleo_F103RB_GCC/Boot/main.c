...
static void usart_print_char(const char str)
{
...
//   6808	    128	   1220	   8156	   1fdc	bin/openblt_nucleo_stm32f103rb.elf
//
  ...
  usart_print("Waiting for response...\r\n");
  usart_print("No response received.\r\n");
usart_print("\n\r");
