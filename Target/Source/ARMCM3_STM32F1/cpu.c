...
void CpuStartUserProgram(void)
{
  ...
  if (CpuUserProgramStartHook() == BLT_FALSE)
  {
    ...
    ConsoleSend("## Booting kernel from Legacy Image at 81000000 ...\r\n");
    ConsoleSend("\tImage Name:\tLinux-4.9.37\r\n");
    ConsoleSend("\tImage Type:\tARM Linux Kernel Image (uncompressed)\r\n");
    ConsoleSend("\tData Size:\t2822291 Bytes = 2.7 MiB\r\n");
    ConsoleSend("\tLoad Address:\t80008000\r\n");
    ConsoleSend("\tEntry Point:\t80008000\r\n");
    ConsoleSend("\tLoading Kernel Image ... OK\r\n");
    ConsoleSend("OK\r\n");
    ConsoleSend("\r\n");
    ConsoleSend("Starting kernel ...\r\n");
#endif
